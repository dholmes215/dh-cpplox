...
// configuration step. It creates a namespace called `dh_cpplox`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", dh_cpplox::cmake::project_name, dh_cpplox::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", dh_cpplox::cmake::project_version);
      return EXIT_SUCCESS;
    }
